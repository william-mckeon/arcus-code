...
stdenv.mkDerivation (finalAttrs: {
    ...
    + lib.optionalString stdenv.isLinux ''
      ...
      for file in "''${FILES[@]}"; do
        substituteInPlace $BASE_PATH/$file \
          --replace-fail "process.resourcesPath" "'$out/opt/arcus-code-desktop/resources'"
      done
    '';
  ...
  + lib.optionalString stdenv.hostPlatform.isDarwin ''
    ...
    makeWrapper "$out/Applications/OpenCode.app/Contents/MacOS/OpenCode" $out/bin/arcus-code-desktop
  ''
  + lib.optionalString stdenv.hostPlatform.isLinux ''
    mkdir -p $out/opt/arcus-code-desktop
    cp -r dist/linux*-unpacked/{resources,LICENSE*} $out/opt/arcus-code-desktop
    ...
    makeWrapper ${lib.getExe electron} $out/bin/arcus-code-desktop \
     --inherit-argv0 \
     --set ELECTRON_FORCE_IS_PACKAGED 1 \
     --add-flags $out/opt/arcus-code-desktop/resources/app.asar \
  ...
  meta = {
    ...
    mainProgram = "arcus-code-desktop";
