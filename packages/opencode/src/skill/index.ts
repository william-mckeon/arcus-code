...
const CUSTOMIZE_OPENCODE_SKILL_NAME = "customize-arcus-code"
// The config filenames below are literal paths on disk, not branding. They still
// read "opencode" because the filesystem namespace has not been renamed yet.
const CUSTOMIZE_OPENCODE_SKILL_DESCRIPTION =
  "Use ONLY when the user is editing or creating Arcus Code's own configuration: opencode.json, opencode.jsonc, files under .opencode/, or files under ~/.config/opencode/. Also use when creating or fixing Arcus Code agents, subagents, skills, plugins, MCP servers, or permission rules. Do not use for the user's own application code, or for any project that is not configuring Arcus Code itself."
const CUSTOMIZE_OPENCODE_SKILL_BODY = SkillPlugin.CustomizeArcusCodeContent
