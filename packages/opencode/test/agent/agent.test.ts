...
it.instance("plan agent denies edits except <config dir>/plans/*", () =>
  Effect.gen(function* () {
    ...
    expect(Permission.evaluate("edit", `${Brand.configDir}/plans/foo.md`, plan!.permission).action).toBe("allow")
  }),
)
